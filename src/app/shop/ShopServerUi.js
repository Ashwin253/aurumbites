        ...
        <div className="flex gap-3">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-[#20bd5c] shadow-sm"
            >
            ...
            <a
              ...
              className="rounded-full border border-neutral-300 p-3 text-neutral-600 transition hover:bg-neutral-50 shadow-sm"
